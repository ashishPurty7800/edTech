        ...
        <div>
            ...
            <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between'>
                ...
                <div className='mt-4 w-[90%] text-center text-lg font-bold text-richblack-300'>
                    ...
                    from anywhere in the world, and get access to <br/> a wealth of resources, 
                ...
                <div>
                    <CodeBlocks 
                        ...
                        subheading={
                            <div>
                                <p>Our courses are designed and taught by industry experts who</p>
                                <p>have years of experience in coding and are passionate about</p>
                                <p>sharing their knowledge with you.</p>
                            </div>
                        }
                        ctabtn1={
                            {
                ...
                <div>
                    <CodeBlocks 
                        ...
                        subheading={
                            <div>
                                <p>Go ahead, give it a try. Our hands-on learning environment</p>
                                <p>means you'll be writing real code from your very first lesson.</p>
                            </div>
                        }
                        ctabtn1={
                            {
