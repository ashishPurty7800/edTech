...
export default function useOnClickOutside(ref, handler) {
    useEffect( () => {
        ...
        // Add event listener for mosedown and touchstart events on the document
        document.addEventListener('mousedown', listener);
        document.addEventListener('touchstart', listener);

        // Cleanup function to remove the event listener when the component unmounts or when the ref/handler dependencies changes
        return () => {
